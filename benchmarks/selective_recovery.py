...
import time
from evidencebound import EvidenceBound, EvidenceRecord, InvalidationReason, PolicyBinding, ProvenanceRecord
...
for i in range(N):
    ...
    eb.checkpoint(agent="bench", evidence=e, output={"node": i}, depends_on=deps, checkpoint_id=cid)
    previous = cid
